...
<template>
  <main>
    <div class="mx-auto flex max-w-4xl justify-between px-5 py-5 md:py-8">
      <router-link
        to="/"
    ...
    <div class="mx-auto mt-10 max-w-xl px-5 py-5 md:mt-32 md:py-8">
      <h1 class="text-9xl">Profile Golden</h1>
    </div>
  </main>
</template>
